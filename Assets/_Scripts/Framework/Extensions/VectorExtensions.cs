...
public static class VectorExtensions
{
    ...
    public static Vector3 RoundToScale( this Vector3 v3, float scale )
    {
        float realScale = 1 / scale;

        v3.x = Mathf.RoundToInt( v3.x / realScale ) * realScale;
        v3.y = Mathf.RoundToInt( v3.y / realScale ) * realScale;
