...
namespace LibNoise.Unity
{
    ...
    public struct Gradient
    {
        ...
        private static Gradient _myTerrain;
        ...
        static Gradient()
        {
            ...
            Gradient._myTerrain.m_data = new List<KeyValuePair<double, Color>>();
            Gradient._myTerrain.m_data.Add(new KeyValuePair<double, Color>(-1.0, Color.blue));
            Gradient._myTerrain.m_data.Add(new KeyValuePair<double, Color>(0, Color.green));
            Gradient._myTerrain.m_inverted = false;
        ...
        public Gradient(List<KeyValuePair<double, Color>> colors, bool inverted)
        {
            this.m_data = colors;
        ...
        public static Gradient MyTerrain
        {
            get { return Gradient._myTerrain; }
        }
        #endregion
