...
namespace LibNoise
{
    ...
    public static class GradientPresets
    {
        ...
        private static readonly Gradient _myTerrain;
        ...
        static GradientPresets()
        {
            ...
            var myTerrainColorKeys = new List<GradientColorKey>
            {
                new GradientColorKey(new Color(0, 0, 0.5f), 0.5f),
                new GradientColorKey(new Color(0.125f, 0.25f, 0.5f), 1f),
            };
            ...
            _myTerrain = new Gradient();
            _myTerrain.SetKeys(myTerrainColorKeys.ToArray(), alphaKeys.ToArray());
        }
